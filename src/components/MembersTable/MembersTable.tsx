...
export const MembersTable: React.FC<MembersTableProps> = (props) => {
  const { members, searchValue, levelFilter, ...useMemberProps } = props;
  ...
  return <DataTable columns={columns} data={members} filter={searchValue} columnFilters={columnFilters} />;
};
